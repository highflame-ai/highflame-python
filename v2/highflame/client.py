...
class Highflame:
    ...
    def __init__(self, config: Config) -> None:
        ...
        self._headers = {"x-highflame-apikey": config.api_key}
        ...
        def override_endpoint_url(request: Any, **kwargs) -> None:
            ...
            try:
                ...
                if self.use_default_bedrock_route and self.default_bedrock_route:
                    request.headers["x-highflame-route"] = self.default_bedrock_route
    ...
    def _create_bedrock_tracing_handlers(self):
        ...
        def bedrock_before_call(**kwargs):
            ...
            context["request_wrapper"] = RequestWrapper(None, span)
        ...
        def bedrock_after_call(**kwargs):
            ...
            wrapper = context.get("request_wrapper")
            if not wrapper:
                return
    ...
    def register_bedrock(
        ...
        Example:
            ...
            >>> modified_client = client.register_bedrock_client(bedrock)
            >>> client.register_bedrock_client(bedrock)
    ...
    def _prepare_request(self, request: Request) -> tuple:
        ...
        if (
            ...
            and "x-highflame-accountid" in headers
        ):
