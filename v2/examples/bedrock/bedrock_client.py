...
# Global Client, used for everything
config = Config(
    base_url=javelin_base_url,
    api_key=api_key,
)
client = Highflame(config)  # Global Client
...
# Register Azure OpenAI client with Highflame
...
# Register DeepSeek client with Highflame
