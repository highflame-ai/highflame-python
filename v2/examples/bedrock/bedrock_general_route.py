...
def get_bedrock_client():
    ...
    Credentials and the Highflame (Bedrock) API Key can come from environment
    ...
    try:
        ...
        bedrock_api_key = os.getenv("HIGHFLAME_API_KEY", "YOUR_BEDROCK_API_KEY")

        custom_headers = {
            "x-highflame-apikey": bedrock_api_key,
            "x-highflame-route": "amazon",
        }

        client = boto3.client(
            service_name="bedrock-runtime",
            region_name="us-east-1",
            endpoint_url=os.path.join(os.getenv("HIGHFLAME_BASE_URL"), "v1"),
