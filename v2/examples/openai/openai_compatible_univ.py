...
# request/response format, Highflame enables seamless integration with various
...
# pattern regardless of the underlying model provider, with Highflame handling
