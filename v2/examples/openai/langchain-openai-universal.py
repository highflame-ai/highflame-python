...
HIGHFLAME_API_KEY = os.environ.get("HIGHFLAME_API_KEY")  # add your javelin api key here
MODEL_NAME_CHAT = "gpt-3.5-turbo"  # For chat
MODEL_NAME_EMBED = "text-embedding-ada-002"
ROUTE_NAME = "openai_univ"
BASE_URL = os.getenv("HIGHFLAME_BASE_URL")  # Default base URL
...
def init_chat_llm_non_streaming():
    ...
    return ChatOpenAI(
        ...
        default_headers={
            "x-highflame-apikey": HIGHFLAME_API_KEY,
            "x-highflame-route": ROUTE_NAME,
            "x-highflame-provider": "https://api.openai.com/v1",
            "x-highflame-model": MODEL_NAME_CHAT,
        },
        streaming=False,
    )
...
def init_embeddings_llm():
    ...
    return OpenAIEmbeddings(
        ...
        default_headers={
            ...
            "x-highflame-route": ROUTE_NAME,
            "x-highflame-provider": "https://api.openai.com/v1",
            "x-highflame-model": MODEL_NAME_EMBED,
        },
    )
...
# -----------------------------------------------------------------------------
def main():
    print("=== LangChain + OpenAI Highflame Examples (No Text Completion) ===")
