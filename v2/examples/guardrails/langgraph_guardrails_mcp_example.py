...
This example demonstrates how to use Highflame's guardrails service through MCP
(Model Context Protocol) with LangGraph to create a ReAct agent that can detect
dangerous prompts and content.

The agent uses the MultiServerMCPClient to connect to Highflame's guardrails service
...
HIGHFLAME_GUARDRAILS_URL = os.getenv(
    "HIGHFLAME_GUARDRAILS_URL", "https://javelin-guardrails.fastmcp.app/mcp"
)


class GuardrailsMCPAgent:
    """
    A ReAct agent that uses MCP to access Highflame's guardrails service
    ...
    def __init__(
        ...
        Args:
            ...
            api_key: Highflame API key for accessing guardrails service
            base_url: Highflame base URL
    ...
    async def initialize(self) -> None:
        ...
        self.client = MultiServerMCPClient(
            {
                "guardrails": {
                    ...
                    "url": HIGHFLAME_GUARDRAILS_URL,
                    "headers": {"x-highflame-apikey": self.api_key},
                },
            }
        )
        ...
        self.agent = create_react_agent(
            ChatOpenAI(
                ...
                default_headers={
                    "x-highflame-apikey": self.api_key
                },
...
async def main():
    ...
    required_vars = ["OPENAI_API_KEY", "HIGHFLAME_API_KEY", "HIGHFLAME_BASE_URL"]
