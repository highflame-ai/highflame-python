...
# or whatever you’ve set in Azure. Must also match x-highflame-model if
# Highflame expects that.
model_choice = "gpt35"

# Highflame route name, as registered in your javelin route dashboard
route_name = "azureopenai_univ"

print("Azure OpenAI key:", "FOUND" if azure_openai_api_key else "MISSING")
print("Highflame key:", "FOUND" if api_key else "MISSING")
...
llm_non_streaming = AzureChatOpenAI(
    ...
    # The base_url is Highflame’s universal route
    ...
    default_headers={
        ...
        "x-highflame-model": model_choice,
        "x-highflame-provider": "https://javelinpreview.openai.azure.com",
    },
