...
async def main():
    print("Highflame Asynchronous Example Code")
    """
    Create a Client object. This object is used to interact
    with the Highflame API. The base_url parameter is the URL of the Highflame API.
    """
