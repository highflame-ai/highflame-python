...
_Make sure that the file `pyproject.toml` reverted before commit back to main_

### Installation

```python
  pip install highflame-sdk
```
...
pip uninstall highflame-sdk -y

# Build the package
poetry build

# Install the newly built package
pip install dist/highflame_sdk-<version>-py3-none-any.whl
```
